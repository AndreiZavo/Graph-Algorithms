class Graph(object):
    ...
    def create_the_in_and_out_dict(self):
        ...
        for vortex_index in range(0, int(number_of_vortexes) + 1):
...
class GraphFile(Graph):
    ...
    def remove_edge(self, edge_to_remove):
        # overwrites the function of removal of an edge from the list
        self._read_from_file()
        Graph.remove_edge(self, edge_to_remove)
        self._write_to_file()
    ...
    def update_edge(self, start_vertex, end_vertex, new_cost):
        # overwrites the function that updates an edge and writes it into the file
        self._read_from_file()
        Graph.update_edge(self, start_vertex, end_vertex, new_cost)
        self._write_to_file()
